...
public class ProductServiceProcessor {
    ...
    public Object receiveMessage(ProductServiceRequest request) {
        ...
        if (request.getRequestType().equals("createProduct")) {
            ...
            String url = "http://WarehouseApp:9297/addProduct";
            ...
            String url = "http://WarehouseApp:9297/findAllComponents";
            ...
            String url = "http://WarehouseApp:9297/findAllProducts";
            ...
            String url = "http://WarehouseApp:9297/findProductsById/" + request.message;
            ...
            ObjectMapper mapper = new ObjectMapper();
            String url = "http://WarehouseApp:9297/findUserProducts/" + request.message;
            ...
            String[] arr = request.message.split(",");
            String url = "http://WarehouseApp:9297/updateProduct";
            ...
            String url = "http://WarehouseApp:9297/delete/" + request.message;
